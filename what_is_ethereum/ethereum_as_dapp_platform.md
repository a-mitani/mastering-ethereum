...
EOAは、我々ユーザーの任意のタイミングで「トランザクション」を生成・送信し、他のEOAやコントラクト・アカウントとのやり取り、またはコントラクト・アカウントの生成を行います。コントラクトアカウントは、EOAや他のコントラクトアカウントからのトランザクションｎやメッセージの受信をトリガに動作しそのアカウント内に持つコードが実行されます。
