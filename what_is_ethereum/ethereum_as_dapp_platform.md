...
###ether
Ethereumには、「ether」と呼ばれる独自の内部通貨が規定されています。etherは、アカウント間で送受信され、ビットコインと同じような価値を持つ暗号通貨としても利用可能ですが、さらに重要なのはcontractの実行のための費用として利用されるところにあります。ビットコインと同様にetherは採掘に成功した採掘者に報酬として発行されます。
