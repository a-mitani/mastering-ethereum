...
従来のシステムのように、中央管理機関が存在していれば、この太郎の生成したトランザクションに従い、その機関で管理する台帳を更新すればよいだけです。たとえ太郎に悪意があって花子に 25 BTC を送った後に、同じUTXOを使って別の人に 25BTC 送ろうとしても、中央機関はそのUTXOは使用済みと知っているので、使えないとすればよいだけで、非常にシンプルです。

ここで問題になるのは、太郎に悪意があり花子に 25 BTC 送金した後、
