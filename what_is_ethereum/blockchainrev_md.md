...
例えば、太郎は以前に、友人Aから 10 BTC、友人Bから 20 BTC のビットコインをもらったとします。そうすると太郎は２つのUTXOを保持しておりその総額が 30 BTCなので、太郎はビットコイン30 BTC を保有している、ということになります。
...
従来のシステムのように、中央管理機関が存在していれば、この太郎の生成したトランザクションに従い、その機関で管理する台帳を更新すればよいだけです。システムの参加者はこの中央機関の管理する台帳が「正」であると皆で合意できます。また、たとえ太郎に悪意があって、花子に 25 BTC を送った後に同じUTXOを使って 25BTC 別の人に送ろうとしても、中央機関はそのUTXOは使用済みと知っているので、「使えない」とすればよいだけで、非常にシンプルです。

しかしここで問題になるのは、太郎に悪意があり花子に 25 BTC 送金した後、
