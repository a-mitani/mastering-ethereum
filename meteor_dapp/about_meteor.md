...
* **Reactive & Realtime**： Meteorではクライアント側からサーバ側まで全てJavascript言語で記述することができます。またクライアント側もWebブラウザ/iOSアプリ/Androidアプリに関わらずJavascript言語でのアプリケーション動作の記述を可能にすることで、完全に統一されたコードの管理が可能になり、コードの共用など開発及び保守のコストが軽減されます。
