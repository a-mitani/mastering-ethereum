...
<!-- [TODO] 実際に動いているのか？はhashrateで観ればよいことTIPに -->
...
'14851500000000000000000'
> eth.getBalance(eth.accounts[1])
'0'
```
先に解説したとおり、coinbaseに紐づいたアカウントに採掘の報酬が与えられているのがわかります。`eth.accounts[address]`は「wei」の単位[^4] で持ち高が表示されます。
